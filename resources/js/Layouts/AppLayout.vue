    ...
    <div class="sidebar">
     ...
     <!-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <nav class="mt-2">
	   ...
	   <ul class="list_group margbtm">
          <li class="nav-item">
            <a href="/admin/index"  :class="{ 'active': isCurrentPath('/admin/index') }"  class="nav-link">
		 ...
		 <li class="nav-item">
			 ...
			 <li class="nav-item">
					<a href="/admin/userlink/all"  :class="{ 'active': isCurrentPath('/admin/userlink/all') }"  class="nav-link">
					  <i class="nav-icon fas fa-th"></i>
					  <p>
						user links  
					  </p>
