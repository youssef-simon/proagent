...
export default{
	components:{
	 ...
	 ,props:{
		 ...
		 const form = reactive({ 
			  	title: props.serviceCategory.title ,
			...
			return { form ,serviceCategory }
			  ...
			  submit() {
				     router.post('/service_category/update/'+this.serviceCategory.id, this.form)
			  }
	 }
}
</script>
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
					 ...
					 <div class="row">
							<div class="col-12">
								   <button @click="submit()"  class="btn btn-success float-right" type="submit">حفظ</button>
							</div>
				  </div>
            </div>
            <!-- /.card-body -->
